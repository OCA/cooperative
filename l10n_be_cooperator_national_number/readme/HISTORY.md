...
- [\#136](https://github.com/OCA/cooperative/issues/136),
  [\#136](https://github.com/OCA/cooperative/issues/136)
...
- Allow removal of national number.
  ([\#139](https://github.com/OCA/cooperative/issues/139))
...
- Added several convenience functions to get national number values on
  `res.partner`.
  ([\#134](https://github.com/OCA/cooperative/issues/134))
...
- Added `get_display_national_number` and `get_require_national_number`
  ...
  ([\#133](https://github.com/OCA/cooperative/issues/133))
