...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-cooperator_website_payment>=16.0dev,<16.1dev',
        'odoo-addon-cooperator_website_recaptcha>=16.0dev,<16.1dev',
        ...
        'odoo-addon-test_cooperator_website_payment>=16.0dev,<16.1dev',
    ],
    classifiers=[
