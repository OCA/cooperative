...
- Ensure that the birthdate field of subscription requests has at least 4 digits and is not in the future. (`#176 <https://github.com/OCA/cooperative/issues/176>`_)
